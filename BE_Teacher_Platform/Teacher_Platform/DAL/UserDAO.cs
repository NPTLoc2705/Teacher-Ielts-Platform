...
namespace DAL
{
    public class UserDAO
    {
        ...
        public UserDAO(TeacherPlatformDbContext context)
        {
        ...
        public async Task<User> FindOrCreateUserFromGoogleAsync(GoogleJsonWebSignature.Payload payload, UserRole roleForNewUser)
        {
        ...
        {
            return await _context.Users
                .Where(u => u.EmailVerified && !u.IsBanned)
                .ToListAsync();
        }
