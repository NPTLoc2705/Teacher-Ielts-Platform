...
const ConfirmationModal: React.FC<ConfirmationModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white w-full max-w-xl rounded-xl overflow-hidden border border-slate-200">
        ...
        <div className="p-8 space-y-10">
          <RatingScale
            label="1. Bạn hãy cho biết mức độ tự tin của bản thân đối với nội dung tự chấm của bạn?"
            name="ai-feedback-rating"
            value={aiFeedbackRating}
            onChange={setAiFeedbackRating}
          />
          <RatingScale
            label="2. Bạn hãy cho biết mức độ tự tin của bản thân đối với nội dung sửa bài chấm AI của bạn?"
        ...
        <div className="p-6 border-t border-slate-100 flex justify-end gap-3 bg-slate-50/50">
          ...
          <button
            ...
            disabled={isSaving}
            className="px-10 py-2.5 rounded-lg bg-[#183a68] text-white font-bold text-sm hover:bg-[#0f2a4a] transition-all disabled:opacity-60 disabled:cursor-not-allowed"
          >
